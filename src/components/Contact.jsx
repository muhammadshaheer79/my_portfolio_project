    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          ...
          toast.error("Oops! Failed to deliver your message");
          form.current.reset();
        },
      );
  };
    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-stone-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Let&apos;s connect and navigate the rich world of software engineering. Hit me up today to hire me!
          </p>
          <div className="flex items-center gap-2 mt-auto">
            ...
            {socialLinks.map(({ href, icon, alt }, key) => (
              <Tippy content={alt} singleton={target} key={key}>
                <a
                  key={key}
                  href={href}
                  target="_blank"
                  className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-stone-50/5 rounded-lg transition-[background-color,color] hover:bg-[#9ffffc] hover:text-stone-950 active:bg-[#76ddda] reveal-up"
                >
                  {icon}
                </a>
              </Tippy>
        ...
        <form className="xl:pl-10 2xl:pl-20 " ref={form} onSubmit={sendEmail}>
          ...
          <div className="mb-4">
            ...
            <textarea
              name="message"
              id="message"
              placeholder="Hi! Reach out to me with a message"
              required
